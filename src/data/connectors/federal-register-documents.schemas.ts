...
export const FEDERAL_REGISTER_INPUT_SCHEMA = {
  ...
  properties: {
    ...
    publicationDate: {
      ...
      additionalProperties: false,
      description:
        "Optional inclusive publication-date boundary. Omit both bounds for a bounded provider-wide listing.",
...
const FEDERAL_REGISTER_RECORD_SCHEMA = {
  ...
  properties: {
    ...
    jsonUrl: NULLABLE_STRING,
    pdfUrl: NULLABLE_STRING,
    publicInspectionPdfUrl: NULLABLE_STRING,
    bodyHtmlUrl: NULLABLE_STRING,
    fullTextXmlUrl: NULLABLE_STRING,
    rawTextUrl: NULLABLE_STRING,
    regulationsGovUrl: NULLABLE_STRING,
    citation: NULLABLE_STRING,
    commentsCloseOn: {
      anyOf: [{ type: "string", pattern: DATE_PATTERN }, { type: "null" }],
    },
    publicationDate: { type: "string", pattern: `^(?:${DATE_PATTERN.slice(1, -1)})?$` },
    effectiveOn: {
      anyOf: [{ type: "string", pattern: DATE_PATTERN }, { type: "null" }],
    },
    agencies: {
